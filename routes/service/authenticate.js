...
router.post('/signup', function (req, res) {
    ...
    if (req.body.firstname === undefined) validationErrors.push({msg: 'Firstname not available'})
    if (req.body.lastname === undefined) validationErrors.push(({msg: 'Lastname not available'}));
    ...
    UserController.signupUser(parameters.email, parameters)
        ...
        RESPONSE.sendOkay(res, {status:'Failure', message: "Error in signing up the user"})
