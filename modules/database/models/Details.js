...
const ENUMS = require(`${__BASE__}config/enums`);
const DISABILITY_TYPE = ENUMS.disabilityType;
const FINANCIAL_STATUS = ENUMS.financialStatus;
...
let DetailSchema = new mongoose.Schema(
  {
    ...
    isHavingCarInsurance: {
      type: Boolean,
      default: false
    },

    isHavingHealthInsurance: {
      type: Boolean,
      default: false
    },
